...
/opt/mssql-tools18/bin/sqlcmd -S localhost -U sa -P 'YourStrong!Passw0rd' -C -Q "
IF NOT EXISTS (SELECT * FROM sys.databases WHERE name = N'data-db-test')
  CREATE DATABASE [data-db-test];
"

/opt/mssql-tools18/bin/sqlcmd -S localhost -U sa -P 'YourStrong!Passw0rd' -C -d data-db-test -Q "
